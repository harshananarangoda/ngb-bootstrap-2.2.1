...
export class NgbInputDatepicker implements OnChanges,
  ...
  constructor(
      ...
      private ngZone: NgZone, private _service: NgbDatepickerService, private _calendar: NgbCalendar,
  ...
  open() {
    if (!this.isOpen()) {
      ...
      ClosePopup(this.ngZone , document, this._cRef.location.nativeElement, () => this.close(), this._closed$);
